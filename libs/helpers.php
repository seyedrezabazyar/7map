...
function dd($var)
{
    echo "<pre style='direction: ltr; text-align: left; color: #455A64;font-size: 18px;position:relative;background-color:#ffffff;border-radius:10px;z-index: 999;margin: 10px;padding: 20px;border-left: 5px solid #e3133d;'>";
    var_dump($var);
    echo "</pre>";
}
